...
function skuns() {
  ...
  fetch('https://dazzling-elf-4ecfc0.netlify.app/netlify/functions/proxy?url=' + encodeURIComponent("https://market.csgo.com/api/v2/prices/RUB.json")).then(_0x206402 => _0x206402.json()).then(_0x3a85f3 => {
